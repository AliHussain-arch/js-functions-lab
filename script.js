...
function calculateTip(bilAmount,tipPercentage){
    return Math.round(bilAmount*(tipPercentage/100))
}
...
function convertTemperature(value, x){
    if (x === 'c' || x === 'C'){
...
function createUsername(firstName, lastName){
    let totalCharacterCount = firstName.length + lastName.length;
    return firstName.slice(0,3)+lastName.slice(0,3)+totalCharacterCount
}
